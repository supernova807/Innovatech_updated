  ...
  return (
    <div className="relative flex flex-col items-center mt-[-3rem] sm:mt-[-2rem] lg:mt-10">
      ...
      <div className={`transition-all duration-500 w-full flex flex-col items-center ${showPDF ? 'blur-md' : ''}`}>
        ...
        {/* Heading */}
        <h1 className='text-3xl sm:text-5xl lg:text-6xl text-center tracking-wide !text-inherit'>
          Innovatech Software builds softwares
          <span className='bg-gradient-to-r from-green-500 to-green-900 bg-clip-text text-transparent'>{" "}for clients</span>
        </h1>

        {/* Description */}
        <p className='mt-6 sm:mt-8 text-lg text-center text-neutral-500 max-w-4xl'>
        ...
        <div className='flex justify-center my-10'>
          <button
            ...
            className='bg-gradient-to-r from-green-500 to-green-800 py-3 px-4 mx-3 rounded-md text-white font-semibold hover:scale-105 transition-all duration-300'
          >
            Documentation
          </button>
        </div>
        ...
        {/* Video Section */}
        <div className='flex mt-10 justify-center w-full max-w-5xl'>

          <video autoPlay loop muted className='rounded-lg w-1/2 border border-green-800 shadow-green-800 mx-2 my-4'>
          ...
          <>
            ...
            >
              <iframe
                ...
                className="w-3/4 h-[80vh] border rounded-lg shadow-lg bg-white"
              ></iframe>
              ...
              <div className="flex gap-4 mt-5">
                <a
                  ...
                  className='bg-gradient-to-r from-green-500 to-green-800 py-3 px-4 rounded-md text-white font-semibold hover:scale-105 transition-all duration-300'
                  download
                >
                  Download Document
                </a>
